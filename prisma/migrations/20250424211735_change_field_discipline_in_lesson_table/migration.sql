...
-- CreateTable
CREATE TABLE "_CoachToDisciplines" (
    "A" TEXT NOT NULL,
    "B" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_CoachToDisciplines_AB_unique" ON "_CoachToDisciplines"("A", "B");

-- CreateIndex
CREATE INDEX "_CoachToDisciplines_B_index" ON "_CoachToDisciplines"("B");
...
-- AddForeignKey
ALTER TABLE "Lesson" ADD CONSTRAINT "Lesson_disciplineId_fkey" FOREIGN KEY ("disciplineId") REFERENCES "Disciplines"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_CoachToDisciplines" ADD CONSTRAINT "_CoachToDisciplines_A_fkey" FOREIGN KEY ("A") REFERENCES "Coach"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CoachToDisciplines" ADD CONSTRAINT "_CoachToDisciplines_B_fkey" FOREIGN KEY ("B") REFERENCES "Disciplines"("id") ON DELETE CASCADE ON UPDATE CASCADE;
